...
<div class="page-content header-clear-small">
    ...
    <div class="card card-style">
        ...
        <div class="content">
            <h4 class="mb-0">
                ข้อกำหนดและเงื่อนไขการใช้บริการ Line Application “{{ env('APP_HOSNAME') }}”  สำหรับการใช้งานแอปพลิเคชัน ในฐานะบุคคลทั่วไป
            </h4>
            <!--<p class="mb-0 color-highlight font-12 bottom-10">(โปรดอ่านและยอมรับเงื่อนไขการใช้บริการ)</p>-->
            <p>
                ข้าพเจ้า ซึ่งเป็นบุคคลทั่วไป ตกลงใช้บริการ Line Application ”{{ env('APP_HOSNAME') }}” และบริการอื่นที่เกี่ยวเนื่องกัน ตามรายละเอียดการให้บริการที่โรงพยาบาลกำหนด โดย รับทราบ ยอมรับ และตกลงที่จะผูกพันและปฏิบัติตามข้อกำหนดและเงื่อนไขการใช้บริการ ดังต่อไปนี้
            </p>
        </div>
    </div>
    ...
    <div class="card card-style">
        <div class="content">
            <h4 class="">1.	นิยามศัพท์</h4>
                <ol>
                <li>
	“แอปพลิเคชัน” หรือ “Application” หมายความว่า Line Application “{{ env('APP_HOSNAME') }}”  ตลอดจนโปรแกรมคอมพิวเตอร์ ชุดคำสั่ง หรือแอปพลิเคชันอื่น ๆ ที่ต้องใช้หรืออาจใช้ร่วมกันหรือเกี่ยวเนื่องกันกับ Line Application ดังกล่าว เพื่อการใช้บริการ ”{{ env('APP_HOSNAME') }}” ไม่ว่าจะใช้งานผ่านโทรศัพท์มือถือ แท็บเล็ต เว็บ หรือผ่านอุปกรณ์อื่นใดก็ตาม ทั้งนี้ ในกรณีที่ Line application ดังกล่าวเปลี่ยนชื่อเป็นอย่างอื่นหรือมีแอปพลิเคชันอื่นรวมอยู่ด้วย ให้หมายความรวมถึงแอปพลิเคชันนั้นด้วย
                </li>
                <li>
	“บริการ {{ env('APP_HOSNAME') }}” หมายความว่า บริการและคุณสมบัติต่าง ๆ ที่มีให้ใช้งานผ่านแอปพลิเคชันในข้อกำหนดและเงื่อนไขฉบับนี้ ตลอดจนโปรแกรมหรือแอปพลิเคชันอื่น ๆ ของหน่วยบริการที่ต้องใช้หรืออาจใช้ร่วมกันหรือเกี่ยวเนื่องกันกับแอปพลิเคชันดังกล่าว ซึ่งอาจเกี่ยวข้องกับการให้บริการดูแลสุขภาพ หรือไม่เกี่ยวข้องกันก็ได้ ทั้งนี้ ให้หมายความรวมถึงบริการอื่นที่เกี่ยวเนื่องกันกับบริการ “{{ env('APP_HOSNAME') }}” โดยตรง แม้จะดำเนินการโดยบุคคลหรือหน่วยงานอื่น เช่น การออกคิว หรือการชำระเงินผ่านระบบอิเล็กทรอนิกส์ ด้วย
                </li>
                <li>
	“หน่วยบริการ” หมายความว่า โรงพยาบาล สถานีอนามัย หรือที่เรียกชื่อเป็นอย่างอื่นแต่ปฏิบัติงานในลักษณะเดียวกัน และให้หมายความรวมถึงการให้บริการภายนอกสถานที่โดยหน่วยบริการ หรือการให้บริการโดยบุคคลหรือหน่วยงานอื่น ที่ทำการแทนหรือภายใต้อาณัติของหน่วยบริการแห่งนั้นด้วย
                ...
                <li>
	“ผู้ขอใช้บริการ” หมายความว่า ผู้ใช้งาน Line Application “{{ env('APP_HOSNAME') }}”  หรือผู้ป่วยหรือผู้รับบริการของโรงพยาบาลที่ใช้บริการ “{{ env('APP_HOSNAME') }}”  และให้หมายความรวมถึงกรณีที่บิดามารดา ผู้ปกครอง คู่สมรส บุตร ผู้พิทักษ์ ผู้อนุบาล หรือบุคคลอื่นกระทำการแทน ในนาม หรือภายใต้อาณัติของผู้นั้นด้วย
                </li>
                <li>
	“ธุรกรรม” หมายความว่า คำสั่งหรือการกระทำใด ๆ ที่ประสงค์จะให้เกิดผลอย่างใดอย่างหนึ่งเกี่ยวกับการใช้บริการ Line Application “{{ env('APP_HOSNAME') }}” หรือการรับบริการของโรงพยาบาล เช่น การจองคิวโรงพยาบาล การนัดหมาย การเลื่อนนัดหมาย การยกเลิกนัดหมาย การชำระค่าใช้จ่าย ตลอดจนการให้ข้อมูล การเรียกดูข้อมูล การเปลี่ยนแปลงแก้ไขข้อมูล และการลบข้อมูลใด ๆ ที่กระทำผ่านแอปพลิเคชันหรือบริการ Line Application “{{ env('APP_HOSNAME') }}”
                </li>
                <li>
	“ข้อมูลส่วนบุคคล” หมายความว่า ข้อมูลเกี่ยวกับผู้ขอใช้บริการซึ่งทำให้สามารถระบุตัวตนของผู้ขอใช้บริการได้ไม่ว่าทางตรงหรือทางอ้อม ซึ่งรวมถึงข้อมูลทั่วไปของผู้ขอใช้บริการ ข้อมูลที่ใช้ยืนยันตัวตน ข้อมูล ชีวมาตรหรือ biometrics (เช่น ลายนิ้วมือ ใบหน้า เป็นต้น) ข้อมูลการนัดหมาย ข้อมูลการจองคิว ข้อมูลสิทธิการรักษาพยาบาลหรือประกันสุขภาพ ข้อมูลที่จำเป็นสำหรับการชำระเงิน ข้อมูลการทำธุรกรรม ข้อมูลสุขภาพ ความพิการ ข้อมูลพันธุกรรม ข้อมูลการได้ฉีดวัคซีน และข้อมูลส่วนบุคคลอื่นใดเกี่ยวกับผู้ขอใช้บริการ ตามกฎหมายว่าด้วยการคุ้มครองข้อมูลส่วนบุคคล ทั้งนี้ ไม่รวมถึงข้อมูลเกี่ยวกับผู้ขอใช้บริการในกรณีที่ผู้ขอใช้บริการถึงแก่กรรม และไม่รวมถึงข้อมูลทางสถิติหรือข้อมูลที่ไม่สามารถระบุตัวบุคคลที่เป็นเจ้าของข้อมูลส่วนบุคคลได้ ซึ่งไม่ถือเป็นข้อมูลส่วนบุคคลตามกฎหมายว่าด้วยการคุ้มครองข้อมูลส่วนบุคคล
                ...
                <li>
	“ข้อมูลที่ใช้ยืนยันตัวตน” หมายความว่า รหัสผ่าน (password), Personal Identification Number (PIN) หรือรหัสหรือข้อมูลอื่นใดที่ใช้สำหรับการตรวจสอบและยืนยันตัวตนในการเข้าถึงและใช้งานบริการ Line Application “{{ env('APP_HOSNAME') }}” ซึ่งเป็นมาตรการป้องกันการเข้าถึงโดยมิชอบโดยบุคคลอื่น ไม่ว่าจะถูกกำหนดโดยหน่วยบริการ หรือผู้ขอใช้บริการเป็นผู้กำหนดเองก็ตาม ตลอดจนข้อมูลที่ใช้ในการกู้คืนรหัสหรือข้อมูลดังกล่าว (ถ้ามี)
                </li>
                <li>
	“อุปกรณ์การใช้งาน” หมายความว่า โทรศัพท์มือถือ แท็บเล็ต เครื่องคอมพิวเตอร์ หรือเครื่องมือหรืออุปกรณ์อิเล็กทรอนิกส์อื่นใดที่ผู้ขอใช้บริการใช้เพื่อเข้าถึงและใช้งานบริการ Line Application “{{ env('APP_HOSNAME') }}”
                </li>
            </ol>


            <h4 class="">2. การใช้งานแอปพลิเคชันและบริการ Line Application “{{ env('APP_HOSNAME') }}” </h4>
            <ol>
                <li>
	ผู้ขอใช้บริการยอมรับว่า ผู้ขอใช้บริการสามารถดาวน์โหลดและติดตั้ง Line Application “{{ env('APP_HOSNAME') }}” บนอุปกรณ์การใช้งานเพื่อใช้บริการ “{{ env('APP_HOSNAME') }}” ณ ขณะใดขณะหนึ่งได้เพียง 1 อุปกรณ์ (หรือตามที่หน่วยบริการกำหนดเป็นอย่างอื่น) เท่านั้น และหากมีการเข้าใช้บริการโดยอุปกรณ์จำนวนมากกว่าจำนวนที่กำหนดดังกล่าวในเวลาใกล้เคียงกัน ระบบของหน่วยบริการจะให้อุปกรณ์การใช้งานที่เข้ามาใช้บริการหลังสุด เป็นอุปกรณ์ที่ใช้บริการได้เพียงอุปกรณ์เดียวเท่านั้น เว้นแต่หน่วยบริการจะกำหนดเป็นอย่างอื่น
                </li>
                <li>
	ในการเข้าใช้งานแอปพลิเคชันหรือบริการ Line Application “{{ env('APP_HOSNAME') }}” แบ่งคุณสมบัติที่ให้บริการเป็น 2 ส่วนหลัก คือ 1) บริการสำหรับบุคคลทั่วไป และ 2) บริการสำหรับผู้ป่วยหรือผู้รับบริการของหน่วยบริการ โดยบริการสำหรับบุคคลทั่วไป เป็นบริการที่เปิดให้บุคคลทั่วไปเข้าถึงและใช้งานคุณสมบัติทั่วไปไม่ว่าจะเป็นผู้ป่วยหรือผู้รับบริการของหน่วยบริการหรือไม่ก็ตาม โดยไม่ต้องเข้าสู่ระบบ (log in) ส่วนบริการสำหรับผู้ป่วยหรือผู้รับบริการของหน่วยบริการ จะเข้าถึงและใช้งานได้เมื่อผู้ขอใช้บริการได้สมัครเข้าใช้งานแอปพลิเคชัน จากในแอปพลิเคชัน “{{ env('APP_HOSNAME') }}” โดยตกลงยอมรับข้อกำหนดและเงื่อนไขการใช้บริการ “{{ env('APP_HOSNAME') }}” สำหรับการใช้งานในฐานะผู้รับบริการของหน่วยบริการ เป็นการเพิ่มเติมเรียบร้อยแล้ว และหน่วยบริการได้อนุญาตให้ใช้บริการ “{{ env('APP_HOSNAME') }}” โดยผู้ขอใช้บริการต้องเข้าสู่ระบบ (log in) โดยใส่รหัสผ่านหรือข้อมูลที่ใช้ยืนยันตัวตนให้ถูกต้อง พร้อมทั้งปฏิบัติตามวิธีการและเงื่อนไขการใช้บริการที่หน่วยบริการกำหนดอย่างถูกต้องครบถ้วน
                </li>
                <li>
	ผู้ขอใช้บริการยอมรับว่า ทางหน่วยบริการจะถือว่า การใช้บริการ Line Application “{{ env('APP_HOSNAME') }}” ที่กระทำโดยบุคคลอื่น โดยใช้รหัสผ่าน และ/หรือข้อมูลที่ใช้ยืนยันตัวตนของผู้ขอใช้บริการ เพื่อเข้าถึงบริการของผู้ขอใช้บริการ หรือการใช้บริการ “{{ env('APP_HOSNAME') }}” ผ่านอุปกรณ์การใช้งานที่ได้ตั้งค่าให้บัญชีผู้ใช้ (user account) ของผู้ขอใช้บริการเข้าสู่ระบบ (log in) โดยอัตโนมัติและยังไม่ได้ออกจากระบบ (log out) เป็นการใช้บริการในนามและโดยความยินยอมของผู้ขอใช้บริการ และมีผลเสมือนหนึ่งผู้ขอใช้บริการกระทำด้วยตัวเอง โดยผู้ขอใช้บริการตกลงที่จะให้การกระทำดังกล่าวมีผลผูกพันผู้ขอใช้บริการในการใช้บริการกับหน่วยบริการ และหากเป็นกรณีที่มีค่าใช้จ่ายหรือความรับผิดทางแพ่งจากการกระทำดังกล่าวเกิดขึ้น ผู้ขอใช้บริการตกลงรับผิดชอบค่าใช้จ่ายหรือความรับผิดนั้นเต็มจำนวน ทั้งนี้ เว้นแต่จะมีหลักฐานที่สามารถพิสูจน์ได้ว่าเกิดขึ้นโดยผู้ขอใช้บริการไม่รับรู้และไม่ยินยอม หรือเกิดจากความผิดพลาดของหน่วยบริการหรือเหตุสุดวิสัย
                </li>
                <li>
	คุณสมบัติการใช้งาน Line Application “{{ env('APP_HOSNAME') }}” ที่เป็นส่วนหนึ่งของบริการ “{{ env('APP_HOSNAME') }}” ของหน่วยบริการ ในส่วนของบริการสำหรับบุคคลทั่วไป ประกอบด้วยบริการซึ่งผู้ขอใช้บริการสามารถใช้งานได้ตลอด 24 ชั่วโมง (ยกเว้นกรณีที่ผู้พัฒนา Line Application หรือหน่วยบริการ หยุดให้บริการเป็นการชั่วคราวเพื่อบำรุงรักษาระบบหรือกรณีเกิดเหตุขัดข้อง หรือกรณีอื่นๆ) ตามวิธีการและเงื่อนไขที่กำหนดเพิ่มเติมภายในแอปพลิเคชันหรือในการรับบริการของหน่วยบริการ (ถ้ามี) ทั้งนี้ หน่วยบริการอาจเพิ่มเติมคุณสมบัติอื่น หรือเปลี่ยนแปลงหรือยกเลิกคุณสมบัติเหล่านี้ได้ในอนาคต ประกอบด้วยรายการดังนี้
<ul>
<li>(1) การแสดงข้อมูลและประวัติส่วนบุคคลของผู้ใช้บริการ ทั้งข้อมูลการตรวจรักษา การวินิจฉัยโรค ผลการตรวจรักษา ประวัติการนัดหมายและรายละเอียดต่างๆในระบบเวชระเบียนคนไข้ของหน่วยบริการ
	...
	ผู้ขอใช้บริการรับทราบและยอมรับว่า คุณสมบัติบางอย่างของแอปพลิเคชันและการให้บริการ “{{ env('APP_HOSNAME') }}” ของหน่วยบริการ อาจไม่ถูกต้องครบถ้วนโดยสมบูรณ์ หรืออาจไม่เที่ยงตรงหรือแม่นยำ ตามข้อจำกัดต่างๆ เช่น ความแรงของสัญญาณ สัญญาณรบกวน คุณสมบัติของอุปกรณ์ที่ใช้ ข้อจำกัดทางเทคนิค หรือข้อจำกัดอื่นที่ส่งผลต่อความถูกต้อง เที่ยงตรง แม่นยำ หรือคงเส้นคงวาของการระบุตำแหน่งได้ จึงเป็นการใช้งานที่หน่วยบริการไม่สามารถรับประกันความเสียหายหรือปัญหาที่เกิดขึ้นได้
            ...
            <ol><li>
	ในการใช้บริการ “{{ env('APP_HOSNAME') }}” ของผู้ขอใช้บริการ ในส่วนของบริการสำหรับบุคคลทั่วไป ผู้ขอใช้บริการรับทราบว่า อาจมีบางบริการที่หน่วยบริการจำเป็นต้องเก็บ รวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคลของผู้ขอใช้บริการ เท่าที่จำเป็น (เช่น บริการจองคิวและนัดโรงพยาบาล) ซึ่งข้อมูลส่วนบุคคลดังกล่าวอาจรวมถึงข้อมูลทั่วไปของผู้ขอใช้บริการ ข้อมูลที่ใช้ยืนยันตัวตน ข้อมูลการนัดหมาย ข้อมูลสิทธิการรักษาพยาบาล เป็นต้น ในระบบของ “{{ env('APP_HOSNAME') }}” และระบบสารสนเทศอื่นที่เกี่ยวข้องของหน่วยบริการ รวมทั้งไปยังระบบของผู้ให้บริการอื่นที่เกี่ยวเนื่องกัน นอกจากนี้ ผู้ขอใช้บริการยอมรับให้หน่วยบริการติดต่อสื่อสารกับผู้ขอใช้บริการหรือเปิดเผยข้อมูลส่วนบุคคลของผู้ขอใช้บริการเท่าที่จำเป็น เพื่อการตรวจสอบยืนยันตัวตน สอบถามข้อมูล ให้ข้อมูลเกี่ยวกับการบริการ หรือสนับสนุนการรับบริการของผู้ขอใช้บริการผ่านทางโทรศัพท์, ข้อความสั้น (SMS), จดหมายอิเล็กทรอนิกส์ (E-mail) หรือวิธีการอื่นใดที่หน่วยบริการกำหนดและผู้ขอใช้บริการได้ให้ไว้กับหน่วยบริการก่อนหน้านี้ หรือผ่านบริการ “{{ env('APP_HOSNAME') }}” ทั้งนี้ เพื่อให้หน่วยบริการ สามารถให้บริการ “{{ env('APP_HOSNAME') }}” แก่ผู้ขอใช้บริการได้ตามข้อกำหนดและเงื่อนไขการใช้บริการฉบับนี้และข้อกำหนดและเงื่อนไขการใช้บริการอื่น ๆ สำหรับบริการ “{{ env('APP_HOSNAME') }}” โดยถือเป็นการดำเนินการเพื่อปฏิบัติตามสัญญาซึ่งผู้ขอใช้บริการเป็นคู่สัญญาหรือเพื่อดำเนินการตามคำขอของผู้ขอใช้บริการก่อนเข้าทำสัญญา ตามมาตรา 24 (3) แห่งพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562
                </li>
                <li>
	นอกจากข้อ 3.1 หน่วยบริการ อาจจำเป็นจะต้องเก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคลในระบบของ “{{ env('APP_HOSNAME') }}” ในความควบคุมดูแลของหน่วยบริการ โดยมีวัตถุประสงค์เพื่อให้สามารถให้บริการ “{{ env('APP_HOSNAME') }}” ในส่วนของบริการสำหรับบุคคลทั่วไป และบริการอื่นที่เกี่ยวเนื่องกัน แก่ผู้ขอใช้บริการ สำหรับการให้บริการดูแลสุขภาพของหน่วยบริการได้อย่างเต็มที่ ซึ่งข้อมูลดังกล่าวอาจรวมถึงข้อมูลสุขภาพของผู้ขอใช้บริการ เช่น หมู่เลือด ประวัติการแพ้ยา/อาหาร/อื่น ๆ เป็นต้น และในบางกรณีอาจรวมถึงข้อมูลส่วนบุคคลเกี่ยวกับเชื้อชาติ เผ่าพันธุ์ ความเชื่อในลัทธิ ศาสนาหรือปรัชญา หรือข้อมูลอื่นใดซึ่งกระทบต่อผู้ขอใช้บริการในทำนองเดียวกันตามที่คณะกรรมการคุ้มครองข้อมูลส่วนบุคคลประกาศกำหนดด้วย หากหน่วยบริการเห็นว่าข้อมูลดังกล่าวเกี่ยวข้องกับสุขภาพ หรือมีความสำคัญและจำเป็นกับการรับบริการดูแลสุขภาพของผู้ขอใช้บริการ และจำเป็นต้องเก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลดังกล่าวผ่านบริการ “{{ env('APP_HOSNAME') }}” เพื่อประโยชน์ในการให้บริการดูแลสุขภาพแก่ผู้ขอรับบริการเอง เช่น เพื่อเป็นข้อมูลประกอบในการรับบริการสุขภาพตามมาตรฐานคุณภาพและความปลอดภัยของหน่วยบริการ หรือเพื่อตรวจสอบยืนยันตัวตนของผู้ขอใช้บริการ เป็นต้น เพื่อให้การให้บริการ “{{ env('APP_HOSNAME') }}” ของหน่วยบริการ แก่ผู้ขอใช้บริการสามารถดำเนินการได้ ถือเป็นการดำเนินการเพื่อปฏิบัติตามสัญญา ซึ่งผู้ขอใช้บริการเป็นคู่สัญญา ตามมาตรา 24 (3) หรือเป็นการจำเป็นในการปฏิบัติตามกฎหมายเพื่อให้บรรลุวัตถุประสงค์เกี่ยวกับเวชศาสตร์ป้องกันหรืออาชีวเวชศาสตร์ การประเมินความสามารถในการทำงานของลูกจ้าง การวินิจฉัยโรคทางการแพทย์ การให้บริการด้านสุขภาพหรือด้านสังคม การรักษาทางการแพทย์ การจัดการด้านสุขภาพ หรือระบบและการให้บริการด้านสังคมสงเคราะห์ หรือเป็นการปฏิบัติตามสัญญาระหว่างเจ้าของข้อมูลส่วนบุคคลกับผู้ประกอบวิชาชีพทางการแพทย์ ตามมาตรา 26 (5) (ก) หรือเป็นการจำเป็นในการปฏิบัติตามกฎหมายเพื่อให้บรรลุวัตถุประสงค์เกี่ยวกับการคุ้มครองแรงงาน การประกันสังคม หลักประกันสุขภาพแห่งชาติ สวัสดิการเกี่ยวกับการรักษาพยาบาลของผู้มีสิทธิตามกฎหมาย การคุ้มครองผู้ประสบภัยจากรถ หรือการคุ้มครองทางสังคม ซึ่งการเก็บรวบรวมข้อมูลส่วนบุคคลเป็นสิ่งจำเป็นในการปฏิบัติตามสิทธิหรือหน้าที่ของผู้ควบคุมข้อมูลส่วนบุคคลหรือเจ้าของข้อมูลส่วนบุคคล ตามมาตรา 26 (5) (ค) แห่งพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 แล้วแต่กรณี
                </li>
                <li>
	ผู้ขอใช้บริการรับทราบและตกลงให้ความยอมรับให้โรงพยาบาลติดต่อสื่อสารกับผู้ขอใช้บริการหรือเปิดเผยข้อมูลส่วนบุคคลของผู้ขอใช้บริการผ่านทางโทรศัพท์, ข้อความสั้น (SMS), จดหมายอิเล็กทรอนิกส์ (E-mail) หรือวิธีการอื่นใดที่หน่วยบริการกำหนดและผู้ขอใช้บริการได้ให้ไว้กับหน่วยบริการก่อนหน้านี้หรือในการใช้บริการ “{{ env('APP_HOSNAME') }}” เพื่อประโยชน์ในการใช้งานหรือการแก้ไขปัญหาเกี่ยวกับบริการ “{{ env('APP_HOSNAME') }}” รวมทั้ง ตกลงยอมรับให้หน่วยบริการแสดงข้อความแจ้งเตือน สื่อสาร หรือประชาสัมพันธ์ข่าวสารต่าง ๆ เกี่ยวกับบริการ “{{ env('APP_HOSNAME') }}” หรือบริการ หรือข่าวสารอื่นๆภายในแอปพลิเคชัน และโดยการส่ง Notification หรือ Alert หรือข้อความในทำนองเดียวกันผ่านอุปกรณ์การใช้งาน
                </li>
                <li>
	ในกรณีที่ผู้ขอใช้บริการประสงค์จะใช้บริการสำหรับผู้ป่วยหรือผู้รับบริการของโรงพยาบาล (ซึ่งต้องสมัครเข้าใช้งานแอปพลิเคชันจากใน Line Application “{{ env('APP_HOSNAME') }}” นอกเหนือจากบริการสำหรับบุคคลทั่วไป ผู้ขอใช้บริการจะต้องตกลงยอมรับข้อกำหนดและเงื่อนไขการใช้บริการ “{{ env('APP_HOSNAME') }}” สำหรับการใช้งานในฐานะผู้รับบริการของหน่วยบริการ โดยกระทำผ่านแอปพลิเคชันด้วยวิธีการทางอิเล็กทรอนิกส์ และอาจต้องลงนามตกลงยอมรับข้อกำหนดและเงื่อนไขการใช้บริการเป็นลายลักษณ์อักษรกับหน่วยบริการเป็นการเพิ่มเติม (เว้นแต่จะได้ตกลงยอมรับข้อกำหนดและเงื่อนไขการใช้บริการดังกล่าวไปก่อนแล้ว) ทั้งนี้ ตามวิธีการและเงื่อนไขที่หน่วยบริการกำหนด ซึ่งอาจมีเงื่อนไขการเก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคล และการแจ้งรายละเอียดในการเก็บรวบรวมข้อมูลส่วนบุคคลให้เจ้าของข้อมูลส่วนบุคคลทราบ เพิ่มเติมหรือแตกต่างจากในข้อกำหนดและเงื่อนไขฉบับนี้ โดยเฉพาะรายละเอียดเกี่ยวกับการเก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคลที่เป็นข้อมูลสุขภาพของผู้ขอใช้บริการ
                </li>
                <li>
	ผู้ขอใช้บริการรับทราบและยอมรับว่า หากผู้ขอใช้บริการประสงค์จะขอยกเลิกการใช้บริการ “{{ env('APP_HOSNAME') }}” ผู้ขอใช้บริการสามารถแจ้งความประสงค์กับหน่วยบริการได้ตามวิธีการและเงื่อนไขที่หน่วยบริการกำหนด โดยถือเป็นการระงับและยกเลิกการให้บริการ “{{ env('APP_HOSNAME') }}” ตามข้อกำหนดและเงื่อนไขฉบับนี้ และมีผลหลังจากหน่วยบริการดำเนินการตามความประสงค์เสร็จสิ้น แต่การขอยกเลิกการใช้บริการ “{{ env('APP_HOSNAME') }}” ดังกล่าว ไม่ส่งผลกระทบต่อการเก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคลที่ดำเนินการไปแล้วโดยชอบ และหน้าที่ความรับผิดชอบ ตลอดจนค่าใช้จ่ายคงค้างที่ผู้ขอใช้บริการยังคงมีต่อหน่วยบริการยังคงมีผลผูกพันต่อไป ทั้งนี้ การขอยกเลิกการใช้บริการ “{{ env('APP_HOSNAME') }}” อาจส่งผลต่อการอำนวยความสะดวก ความรวดเร็วในการรับบริการ และการรับรู้ข้อมูลเกี่ยวกับการเข้ารับบริการ แต่ไม่มีผลต่อการเข้าถึงและมาตรฐานการให้บริการดูแลสุขภาพของหน่วยบริการ หรือความสัมพันธ์อื่นระหว่างหน่วยบริการในฐานะผู้ให้บริการกับผู้ขอใช้บริการในฐานะผู้ป่วยหรือผู้รับบริการของหน่วยบริการแต่อย่างใด
                </li>
                <li>
	ข้อมูลส่วนบุคคลที่เก็บรวบรวมในการใช้บริการ “{{ env('APP_HOSNAME') }}” นี้ อาจถูกเปิดเผยแก่บุคคลหรือหน่วยงานดังนี้
<ul>
...
</li><li>(6) ในลักษณะอื่นที่ผิดเงื่อนไขในการใช้งานหรือการให้บริการที่กำหนดภายในแอปพลิเคชันหรือในการให้บริการ “{{ env('APP_HOSNAME') }}” หรือตามที่โรงพยาบาลกำหนด
</li></ul>

</li><li>	ในกรณีที่ก่อนหน้านี้ ผู้ขอใช้บริการ “{{ env('APP_HOSNAME') }}” ได้เคยตกลงหรือยอมรับในข้อกำหนดและเงื่อนไขการใช้บริการ “{{ env('APP_HOSNAME') }}”  ของแอปพลิเคชัน “{{ env('APP_HOSNAME') }}” หรือข้อกำหนดและเงื่อนไขการใช้บริการ “{{ env('APP_HOSNAME') }}” สำหรับการใช้งานในฐานะผู้รับบริการของโรงพยาบาล ที่กระทำผ่านวิธีการทางอิเล็กทรอนิกส์ ให้ความตกลงหรือการยอมรับนั้นเป็นอันยกเลิก และให้ใช้ข้อกำหนดและเงื่อนไขการใช้บริการตามเอกสารฉบับนี้แทน ยกเว้นข้อกำหนดและเงื่อนไขการใช้บริการที่ได้ทำไว้กับหน่วยบริการเป็นลายลักษณ์อักษร (ถ้ามี) ให้ยังมีผลใช้บังคับต่อไปจนกว่าจะถูกยกเลิกหรือแก้ไขเพิ่มเติม และข้อกำหนดและเงื่อนไขการใช้บริการ “{{ env('APP_HOSNAME') }}” สำหรับการใช้งานในฐานะผู้รับบริการของหน่วยบริการ (ถ้ามี) ให้เป็นไปตามข้อ 4.4
